                  ...
                  <div className="flex items-center justify-between gap-3">
                    ...
                    >
                      <LikePop likes={r.likes || 0}>
                        ...
                        />
                        {r.liked && user && (
                          <span className="absolute -top-1.5 -right-1 h-[12px] w-[12px] overflow-hidden rounded-full border border-white/40 bg-white/10 ring-2 ring-background">
                            {user.profile_image ? (
                              <img
                              ...
                              <span className="flex h-full w-full items-center justify-center text-[5px] font-black text-primary">
